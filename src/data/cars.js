// ════════════════════════════════════════════════
// NE Racing Elite — CARS DATABASE  (A.4 — 46 GLB Cars)
// ════════════════════════════════════════════════
...
//   cat            Kategorie (für Shop-Filter)
//   flag           Emoji-Flagge
//   price          Kaufpreis €
//   unlockBiome    Welt-ID oder null = sofort verfügbar
//   body/roof/trim/acc  Fallback-Lackfarben (für 2D-Modus / Loading)
//   stripes        Array für Racing-Streifen oder null
//   raceNum        optionale Startnummer
//   w / h          2D-Sprite-Größe (px)
...
//   scale          Skalierungsfaktor für Three.js-Szene (1.0 = Default)
...
const CARS = [
  ...
  {id:'bmw2002t',   brand:'BMW',    name:'2002 Turbo',         year:'1973',cat:'German Performance',flag:'🇩🇪',price:22000, unlockBiome:null,
   ...
   modelPath:'assets/models/cars/bmw2002t/bmw2002t.glb',scale:1.0,rotationOffset:0,
  ...
  {id:'bmw3csl',    brand:'BMW',    name:'3.0 CSL Race',       year:'1973',cat:'German Performance',flag:'🇩🇪',price:35000, unlockBiome:null,
   ...
   modelPath:'assets/models/cars/bmw3csl/bmw3csl.glb',scale:1.0,rotationOffset:0,
  ...
  {id:'p930',       brand:'Porsche',name:'930 Turbo',           year:'1978',cat:'German Performance',flag:'🇩🇪',price:55000, unlockBiome:null,
   ...
   modelPath:'assets/models/cars/p930/p930.glb',scale:1.0,rotationOffset:0,
   desc:'Der Widowmaker'},
  ...
  {id:'charger_rt', brand:'Dodge', name:'Charger R/T 440',       year:'1969',cat:'American Muscle',flag:'🇺🇸',price:45000, unlockBiome:'desert',
   ...
   modelPath:'assets/models/cars/charger_rt/charger_rt.glb',scale:1.0,rotationOffset:0,
   desc:'Muscle-Car-König – 375 PS V8'},

  {id:'charger_dom', brand:'Dodge', name:'Charger Domineer',      year:'1970',cat:'American Muscle',flag:'🇺🇸',price:65000, unlockBiome:'desert',
   ...
   modelPath:'assets/models/cars/charger_dom/charger_dom.glb',scale:1.0,rotationOffset:0,
   // TODO: Stats vom User bestätigen lassen
  ...
  {id:'volvo_240t',  brand:'Volvo', name:'240 Turbo',              year:'1984',cat:'Swedish Classics',flag:'🇸🇪',price:15000, unlockBiome:'city',
   ...
   modelPath:'assets/models/cars/volvo_240t/volvo_240t.glb',scale:1.0,rotationOffset:0,
  ...
  {id:'saab_99t',    brand:'Saab',  name:'99 Turbo',               year:'1978',cat:'Swedish Classics',flag:'🇸🇪',price:18000, unlockBiome:'forest',
   ...
   modelPath:'assets/models/cars/saab_99t/saab_99t.glb',scale:1.0,rotationOffset:0,
...
// ════════════════════════════════════════════════
// GLB MODEL REGISTRY — schneller Lookup: id → modelPath
// ════════════════════════════════════════════════
